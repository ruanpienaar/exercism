defmodule CommunityGardenTest do
  ...
  test "drop plot_id" do
    assert [] = CommunityGarden.drop_plot_id([], 1)
    assert [] = CommunityGarden.drop_plot_id([%Plot{plot_id: 1, registered_to: "Dude"}], 1)
    assert [%Plot{plot_id: 2, registered_to: "OtherDude"}] =
      CommunityGarden.drop_plot_id([%Plot{plot_id: 1, registered_to: "Dude"}, %Plot{plot_id: 2, registered_to: "OtherDude"}], 1)
    assert [%Plot{plot_id: 1, registered_to: "Dude"}] =
      CommunityGarden.drop_plot_id([%Plot{plot_id: 1, registered_to: "Dude"}, %Plot{plot_id: 2, registered_to: "OtherDude"}], 2)
  end
